 ...
 */
public class PayedSearchedResult extends ArrayAdapter {
    ...
    public PayedSearchedResult(Context context, String[] titles1, String[] busTime, int[] img1, String[] numberOfSeats, String[] bustTicketPrice) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View row = layoutInflater.inflate(R.layout.payedlistitems, parent, false);
